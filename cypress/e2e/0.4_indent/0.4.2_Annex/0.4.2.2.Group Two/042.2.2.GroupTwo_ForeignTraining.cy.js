...
it('Group One - SSM', function() {
  ...
  //Foreign Training
  cy.get('#simple-tabpanel-GROUP_2 > :nth-child(1) > .css-wtqwac > .uiBasicTab > .boxBottomBorder > .MuiTabs-root > .MuiTabs-scroller > .MuiTabs-flexContainer > [tabindex="-1"]')
  .click()
  cy.wait(250)
  ...
  //5. Remarks
  cy.get('#simple-tabpanel-FOREIGN_TRAINING > div > div > div.MuiBox-root.css-1cp3jg2 > div > div > div:nth-child(4) > div > div.jodit-react-container > div > div.jodit-workplace')
  .click()

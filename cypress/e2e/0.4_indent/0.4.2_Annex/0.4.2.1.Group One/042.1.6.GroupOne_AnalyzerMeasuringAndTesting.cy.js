...
it('Group One - SSM', function() {
  ...
  //5. Description
  cy.get('#simple-tabpanel-ANALYZER_MEASURING_AND_TESTING > div > div > div.MuiBox-root.css-1tx28v3 > div > div > div > div.MuiBox-root.css-12q511y > div > div > div:nth-child(3) > div > div.jodit-react-container > div > div.jodit-workplace')
  .click()
  .type('ABCDEFGHTJKLMNOPQRSTUVWXYZ')
  cy.wait(250)

  //6. Remarks
  cy.get('#simple-tabpanel-ANALYZER_MEASURING_AND_TESTING > div > div > div.MuiBox-root.css-1tx28v3 > div > div > div > div.MuiBox-root.css-12q511y > div > div > div:nth-child(4) > div > div.jodit-react-container > div > div.jodit-workplace')
  .click()
  .type('ABCDEFGHTJKLMNOPQRSTUVWXYZ')
  cy.wait(250)
